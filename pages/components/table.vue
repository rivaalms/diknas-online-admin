                        ...
                        <v-row>
                           <v-col cols="12" md="6">
                              <v-autocomplete
                                 ...
                                 :items="formSchool"
                                 :loading="formSchoolLoading"
                                 :search-input.sync="formSchoolSync"
                                 hide-no-data
                                 item-text="name"
                                 item-value="id"
                                 label="Sekolah"
      ...
      methods: {
         ...
         async dialog(type, item) {
            ...
            if (this.isEdit) { 
               ...
               await this.$axios.get('/admin/searchSchoolFilter', {params: {school_id: this.targetItem.school_id}}).then((resp) => {
                  this.formSchool = resp.data.data
